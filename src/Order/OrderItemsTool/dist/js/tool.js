...
Nova.booting(function (Vue, router) {
    Vue.component('order-items-tool', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    fetchResource: function fetchResource() {
      ...
      Nova.request().get(this.api).then(function (_ref) {
        var data = _ref.data;

        _this.resource = data;
      });
    },
    assignmentWarehouse: function assignmentWarehouse() {
      var _this2 = this;

      Nova.request().get(this.assignmentWarehouseApi).then(function (_ref2) {
        var data = _ref2.data;

        _this2.assignments = data;
      });
    }
  },
  ...
  computed: {
    ...
    assignmentWarehouseApi: function assignmentWarehouseApi() {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Promise.all([this.fetchResource(), this.assignmentWarehouse()]);
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("el-table-column", {
        attrs: { prop: "variant.variantName", label: "商品名称" }
      }),
      _vm._v(" "),
      _c("el-table-column", { attrs: { prop: "quantity", label: "数量" } }),
      _vm._v(" "),
      _c("el-table-column", {
        attrs: { label: "出货仓库" },
        scopedSlots: _vm._u([
            ...
            fn: function(scope) {
              return [
                _c(
                  ...
                  _vm._l(_vm.assignments[scope.row.variant.id], function(item) {
                    return _c(
                      "el-option",
                      {
                        key: item.id,
